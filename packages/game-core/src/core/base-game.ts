...
import type { DatabaseProvider, GameStateData } from './database.js';
    ...
    try {
      ...
      if (!validation.valid) {
        throw errorHandler.handleValidationError(
          validation.error ?? 'Invalid move data format',
          {
            ...context,
            details: { moveData },
          }
